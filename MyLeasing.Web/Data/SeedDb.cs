...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Juan", "Zuluaga", "salvaga@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Manager");//"Manager"
        ...
        private async Task CheckContractsAsync()
        {
            ...
            if (!_context.Contracts.Any())
            {
                _context.Contracts.Add(new Contract
                {
                    ...
                    + " volutpat ultrices ex, sed cursus sem tincidunt ut. Nullam metus lorem, convallis quis dignissim quis,"+
                    " porttitor quis leo. In hac habitasse platea dictumst. Duis pharetra sed arcu ac viverra. Proin dapibus lobortis" + "" +
                    " commodo. Vivamus non commodo est, ac vehicula augue. Nam enim felis, rutrum in tortor sit amet, efficitur" +
                    " hendrerit augue. Cras pellentesque nisl eu maximus tempor. Curabitur eu efficitur metus. Sed ultricies urna " 
                    + "et auctor commodo."
                });
